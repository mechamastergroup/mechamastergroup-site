...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (themeToggleBtn) {
      themeToggleBtn.innerHTML = theme === 'dark'
        ? `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
             ...
             <line x1="18.36" y1="18.36" x2="19.78" y2="4.22"></line>
  ...
  // 4. Portfolio Filter
  // All, MEP, Machines, Fluid & Thermal, CAD & Assemblies
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', (e) => {
      ...
      displayToast(
        'Thank you for contacting MechaMaster Group. Your inquiry has been received and our engineering team will respond promptly.'
      );
  ...
  if (newsForm) {
    ...
    newsForm.addEventListener('submit', (e) => {
      ...
      displayToast(
        'Thank you for subscribing to MechaMaster Engineering Digest!'
      );
